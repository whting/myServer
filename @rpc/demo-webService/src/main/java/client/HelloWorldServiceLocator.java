...
public class HelloWorldServiceLocator extends org.apache.axis.client.Service implements client.HelloWorldService {
    ...
    private java.lang.String HelloWorld_address = "http://localhost:9000//services/HelloWorld";
    ...
    public javax.xml.namespace.QName getServiceName() {
        return new javax.xml.namespace.QName("http://localhost:9000/HelloWorld", "HelloWorldService");
    }
    ...
    public java.util.Iterator getPorts() {
        if (ports == null) {
            ...
            ports.add(new javax.xml.namespace.QName("http://localhost:9000/HelloWorld", "HelloWorld"));
        }
